...
\titlegraphic{\includegraphics[height=1.5cm]{fig/labsticc.png}\quad\includegraphics[height=2cm]{logos/IMT_Atlantique_logo.png}}
  ...
  \begin{minipage}[t][5.0cm][t]{\textwidth}
    \begin{columns}[T]
      ...
      \begin{column}{0.40\textwidth}
        \only<1-2>{\includegraphics[width=\textwidth]{fig/full_tensilica}\\ \vspace{0.5cm}}
  ...
  \begin{minipage}[t][5.0cm][t]{\textwidth}
    \begin{columns}[T]
      ...
      \begin{column}{0.33\textwidth}
        ...
        \only<3>{\includegraphics[width=.9\textwidth]{fig/UEE2}}
      \end{column}
    \end{columns}
  \end{minipage}
  \begin{figure}[htp]
    ...
    \only<3>{\includegraphics[width=\textwidth]{fig/frise18}}
  \end{figure}
...
\begin{frame}[t]{Axe de recherche 1 : Maintenance prédictive}
  \begin{minipage}[t][5.0cm][t]{\textwidth}
    ...
    \begin{figure}[htp]
      \centering
      \only<+>{\vspace*{-0.5cm}\includegraphics[width=0.8\textwidth]{fig/research/worldcast/dashboard.jpg}}
