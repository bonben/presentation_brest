...
\begin{frame}[t]{UE \'Electives}
  ...
  \begin{figure}[htp]
    ...
    \only<3>{\includegraphics[width=\textwidth]{fig/frise9}}
  ...
  \begin{minipage}[t][5.0cm][t]{\textwidth}
    \begin{columns}[T]
      ...
      \begin{column}{0.33\textwidth}
        ...
        \only<4->{\includegraphics[width=\textwidth]{fig/ilp-1}}
      \end{column}
    \end{columns}
  \end{minipage}
  \begin{figure}[htp]
...
\begin{frame}[t]{Simulation haut débit de chaînes de communications}
  \begin{minipage}[t][5.0cm][t]{\textwidth}
    \begin{columns}[T]
      ...
      \begin{column}{0.33\textwidth}
        \centering
        \only<1->{\includegraphics[width=0.3\textwidth]{fig/aff3ct}\\ \vspace{0.5cm}}
...
\begin{frame}[t]{Collaboration internationales}
  \begin{minipage}[t][5.0cm][t]{\textwidth}
    \begin{columns}[T]
      ...
      \begin{column}{0.33\textwidth}
      \centering
        \only<1->{\includegraphics[width=0.5\textwidth]{fig/poly}\\ }
        \only<2->{\includegraphics[width=0.5\textwidth]{fig/mcgill}\\}
        \only<3->{\includegraphics[width=1\textwidth]{fig/tampere}}
      \end{column}
    \end{columns}
  \end{minipage}
  \begin{figure}[htp]
